...
- App Store Connect request client for health check, certificate creation, bundle ID listing/creation, device registration, and provisioning profile creation
...
- add Apple API revocation/delete operations for certs, profiles, and bundle IDs
